...
video4 = FactoryBot.create(:video, streamer: streamer)
video5 = FactoryBot.create(:video, streamer: streamer2)
video6 = FactoryBot.create(:video, streamer: streamer3)

playlist = FactoryBot.create(:playlist, videos: [video, video2], streamers: [streamer, streamer2])
