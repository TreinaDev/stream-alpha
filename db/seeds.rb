...
video = Video.create!(name: 'Gameplay do beta do Battlefield!', description: 'O jogo está muito bugado...', link: '946275951', game: game1, streamer: streamer1)
video1 = FactoryBot.create(:video, :approved, streamer: streamer1, link: '76979871', game: game1)
...
video4 = FactoryBot.create(:video, streamer: streamer1)
video5 = FactoryBot.create(:video, streamer: streamer2)
video6 = FactoryBot.create(:video, :refused, streamer: streamer3)

loose_video_price = Price.create!(value: 10.00, loose: true, video: video)
