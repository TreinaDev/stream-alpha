...
client_profile = FactoryBot.create(:client_profile, :with_photo, client: client1)
...
streamer_profile = FactoryBot.create(:streamer_profile, :with_photo, streamer: streamer1)
...
content_streamer = ContentStreamer.create!({ streamer: streamer1, plan: plan1 })
...
loose_video_price = FactoryBot.create(:price, loose: true)

video1 = FactoryBot.create(:video, streamer: streamer1, link: '76979871', game: game1, price: loose_video_price)
video2 = FactoryBot.create(:video, streamer: streamer2, link: '647748643', game: game2, price: loose_video_price)
video3 = FactoryBot.create(:video, streamer: streamer3, link: '83558749', game: game3, price: loose_video_price)
video4 = FactoryBot.create(:video, streamer: streamer1, price: loose_video_price)
video5 = FactoryBot.create(:video, streamer: streamer2, price: loose_video_price)
video6 = FactoryBot.create(:video, streamer: streamer3, price: loose_video_price)

playlist = FactoryBot.create(:playlist, videos: [video1, video2], streamers: [streamer1, streamer2])
